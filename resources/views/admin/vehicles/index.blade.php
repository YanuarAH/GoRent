...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div class="bg-gray-50 rounded-lg p-6">
            ...
            {{-- <a href="{{ route('admin.details', $vehicle->id) }}" class="block w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white text-center rounded-md font-medium transition duration-200">
                View Details
            </a> --}}
        </div>
        @endforeach
